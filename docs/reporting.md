# Reporting
By default, reports are written once a day, 15 minutes before market closing (in admin panel under report settings, "daily report minute shift"). At the same time, order decisions are performed. Reports can also be written within the day, strategies "Intraday" must be selected for a stock exchange in the admin panel.
